...
TUPLE_BASE=$(zip4 "$WORKLOADS_BASE" "$CONFS_BASE" "$SECTIONS_BASE" "$PARAMETERS_BASE")
TUPLE_COMPETING=$(zip4 "$WORKLOADS_COMPETING" "$CONFS_COMPETING" "$SECTIONS_COMPETING" "$PARAMETERS_COMPETING")
