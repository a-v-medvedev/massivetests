...
struct input_maker_fs1D : public input_maker<parallel_conf_t> {
...
template <typename parallel_conf_t>
struct output_maker_fs1D : public output_maker<parallel_conf_t> {
    output_maker_fs1D(test_scope<traits> &_scope, const std::string &_outfile) 
