...
struct input_maker_aramco : public input_maker<parallel_conf_t> {
    using input_maker<parallel_conf_t>::testitem;
    using input_maker<parallel_conf_t>::scope;
    input_maker_aramco(test_scope<traits> &_scope) : input_maker<parallel_conf_t>(_scope) {
...
template <typename parallel_conf_t>
struct output_maker_aramco : public output_maker<parallel_conf_t> {
    output_maker_aramco(test_scope<traits> &_scope, const std::string &_outfile) 
